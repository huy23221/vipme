...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>VIPMODE chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "VIPMODE", HidePremium = false, IntroText = "VIPMODE⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("VIPMODE SCRIPT")
W:AddLabel("DiscordVIPMODE")
local Section = W:AddSection({
    Name = "Status"
})
